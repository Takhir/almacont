...
//    Route::get('/currency/{category}/edit', \App\Http\Controllers\Directory\Currency\EditController::class)->name('currency.edit');
//    Route::get('/currency/{category}', \App\Http\Controllers\Directory\Currency\ShowController::class)->name('currency.show');
//    Route::patch('/currency/{category}', \App\Http\Controllers\Directory\Currency\UpdateController::class)->name('currency.update');
//    Route::delete('/currency/{category}', \App\Http\Controllers\Directory\Currency\DeleteController::class)->name('currency.delete');
});
