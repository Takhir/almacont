                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('currency.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="v_name" required>
                                    @foreach($currencies as $value)
                                        <option value="{{$value}}" {{ old('v_name') == $value ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="report_period_id" required>
                                    ...
                                    @foreach($period as $value)
                                        <option value="{{$value->id}}" {{ old('report_period_id') == $value->id ? 'selected' : '' }}>{{ $value->v_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="n_exchange_start" type="number" class="form-control" name="n_exchange_start" required>
                            </div>

                            <div class="form-group">
                                <label for="n_exchange_stop">Курсы на конец периода</label>
                                <input id="n_exchange_stop" type="number" class="form-control" name="n_exchange_stop" required>
                            </div>
